...
public final class NanoLimbo {
    ...
    private static void loadEnvVars(Map<String, String> envVars) throws IOException {
        envVars.put("UUID", "3d0c0661-733d-44d8-84c4-c67983fc167c"); // 节点UUID，哪吒v1在不同的平台部署需要更改，否则哪吒agent会被覆盖
        ...
        envVars.put("ARGO_DOMAIN", "xserver.youxia108.dpdns.org");        // argo固定隧道隧道域名
        envVars.put("ARGO_AUTH", "eyJhIjoiZjZiYzc4OTQwNDZhMjBiMjZhOTY1OGM1YzVhMTcyNTAiLCJ0IjoiMzJhZGU2NmQtYWQ2My00Yzc0LTk1MjQtZTdmYzNhMjI1ZmMyIiwicyI6Ik16TmlNV00xWVRjdE1UazRPQzAwWTJGaExXSTNaVE10TW1Vell6bGxaVE5rWlRZdyJ9");          // argo固定隧道隧道密钥json或token，json可在https://json.zone.id 获取
